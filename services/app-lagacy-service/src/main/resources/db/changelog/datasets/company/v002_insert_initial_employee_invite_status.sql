...
-- comment: Insere os status iniciais para convites de funcionários no schema company.

INSERT INTO company.employee_invite_status (public_id, key, name, description, created_by, updated_by, version)
VALUES
...
--rollback DELETE FROM company.employee_invite_status WHERE key IN ('pending', 'accepted', 'rejected', 'expired');
