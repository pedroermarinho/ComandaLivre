...
--rollback DROP INDEX IF EXISTS idx_feature_flags_enabled;
...
--rollback DROP INDEX IF EXISTS idx_event_log_created_at;
--rollback DROP INDEX IF EXISTS idx_event_log_actor_user_sub;
--rollback DROP INDEX IF EXISTS idx_event_log_event_key;
--rollback DROP TABLE IF EXISTS public.event_log;
...
--rollback DROP INDEX IF EXISTS public.idx_user_addresses_address_id;
--rollback DROP INDEX IF EXISTS public.idx_user_addresses_user_id;
--rollback DROP TABLE IF EXISTS public.user_addresses;
...
--rollback DROP INDEX IF EXISTS public.idx_notifications_user_id;
--rollback DROP INDEX IF EXISTS public.idx_notifications_event_key;
--rollback DROP INDEX IF EXISTS public.idx_notifications_user_id_read_at;
...
--rollback DROP TABLE IF EXISTS public.features_catalog;
...
--rollback DROP TABLE IF EXISTS public.feature_groups;
...
--rollback DROP INDEX IF EXISTS public.idx_user_feature_groups_feature_group_id_on_user_feature_groups;
--rollback DROP INDEX IF EXISTS public.idx_user_feature_groups_user_id_on_user_feature_groups;
--rollback DROP TABLE IF EXISTS public.user_feature_groups;
...
--rollback DROP INDEX IF EXISTS public.idx_group_feature_permissions_feature_id_on_gfp;
--rollback DROP INDEX IF EXISTS public.idx_group_feature_permissions_feature_group_id_on_gfp;
--rollback DROP TABLE IF EXISTS public.group_feature_permissions;
