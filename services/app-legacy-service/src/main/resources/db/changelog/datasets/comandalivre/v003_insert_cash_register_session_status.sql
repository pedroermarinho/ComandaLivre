...
INSERT INTO comandalivre.cash_register_session_status (public_id, key, name, description)
VALUES
...
--rollback DELETE FROM comandalivre.cash_register_session_status WHERE key IN ('OPEN', 'CLOSED', 'IN_REVIEW');
