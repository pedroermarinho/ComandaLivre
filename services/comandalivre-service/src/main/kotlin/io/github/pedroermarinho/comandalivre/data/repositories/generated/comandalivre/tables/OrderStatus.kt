...
open class OrderStatus(
    ...
    /**
     * The column <code>public.order_status.public_id</code>.
     */
    val PUBLIC_ID: TableField<OrderStatusRecord, UUID?> = createField(DSL.name("public_id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.order_status.key</code>. Chave textual única para
    ...
    /**
     * The column <code>public.order_status.name</code>. Nome legível do status.
     */
    ...
    /**
     * The column <code>public.order_status.description</code>. Descrição
     * opcional do status
     */
    ...
    /**
     * The column <code>public.order_status.created_at</code>.
     */
    ...
    /**
     * The column <code>public.order_status.updated_at</code>.
     */
    ...
    /**
     * The column <code>public.order_status.deleted_at</code>.
     */
