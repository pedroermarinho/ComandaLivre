...
--changeset pedroermarinho:V002_insert_reservation_status_values

INSERT INTO table_reservation_status (public_id, key, name, description)
VALUES
...
--rollback sqlFile:path=../rollbacks/datasets/V002_insert_reservation_status_values_undo.sql
