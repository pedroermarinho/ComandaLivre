...
--rollback DROP TABLE IF EXISTS table_status;
...
--rollback DROP TABLE IF EXISTS command_status;
...
--rollback DROP TABLE IF EXISTS order_status
...
--rollback DROP INDEX IF EXISTS idx_rtables_status_id;
--rollback DROP INDEX IF EXISTS idx_rtables_company_id;
--rollback DROP TABLE IF EXISTS tables;
...
--rollback DROP INDEX IF EXISTS idx_products_company_id;
--rollback DROP INDEX IF EXISTS idx_products_name_category;
...
--rollback DROP INDEX IF EXISTS idx_pmg_product_id;
--rollback DROP TABLE IF EXISTS product_modifiers_groups;
...
--rollback DROP INDEX IF EXISTS idx_pmo_modifier_group_id;
--rollback DROP TABLE IF EXISTS product_modifiers_options;
...
--rollback DROP INDEX IF EXISTS idx_orderitems_status_id;
--rollback DROP INDEX IF EXISTS idx_orderitems_product_id;
--rollback DROP INDEX IF EXISTS idx_orderitems_command_id;
...
--rollback DROP INDEX IF EXISTS idx_oid_modifier_option_id;
--rollback DROP INDEX IF EXISTS idx_oid_order_item_id;
--rollback DROP TABLE IF EXISTS order_item_details;
