...
--rollback ALTER TABLE order_items RENAME COLUMN total_modifiers_price_at_order TO total_modifiers_price;
--rollback ALTER TABLE order_items RENAME COLUMN base_price_at_order TO item_price_at_order;
--rollback ALTER TABLE order_item_modifiers DROP CONSTRAINT uq_order_item_modifier;
--rollback ALTER TABLE order_item_modifiers RENAME COLUMN price_at_order TO price_at_selection;
--rollback ALTER TABLE order_item_modifiers RENAME TO order_item_details;
--rollback ALTER TABLE product_modifiers_groups DROP CONSTRAINT chk_selection_logic;
