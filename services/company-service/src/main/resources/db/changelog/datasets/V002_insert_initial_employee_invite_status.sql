...
--changeset pedroermarinho:V002_insert_initial_employee_invite_status
...
--rollback sqlFile:path=../rollbacks/datasets/V002_insert_initial_employee_invite_status_undo.sql
