...
--rollback DROP TABLE IF EXISTS company_types;
...
--rollback DROP TABLE IF EXISTS role_types;
...
--rollback DROP INDEX IF EXISTS idx_companies_cnpj;
--rollback DROP INDEX IF EXISTS idx_companies_name_type;
...
--rollback DROP TABLE IF EXISTS company_settings;
...
--rollback DROP INDEX IF EXISTS idx_employees_company_id_user_id;
...
--rollback DROP TABLE IF EXISTS employee_invite_status;
...
--rollback DROP INDEX IF EXISTS idx_employee_invites_company_id;
--rollback DROP INDEX IF EXISTS idx_employee_invites_user_id;
--rollback DROP INDEX IF EXISTS idx_employee_invites_email;
--rollback DROP INDEX IF EXISTS idx_employee_invites_token;
--rollback DROP TABLE IF EXISTS employee_invites;
