...
open class Projects(
    ...
    /**
     * The column <code>public.projects.name</code>. Nome do projeto.
     */
    ...
    /**
     * The column <code>public.projects.code</code>. Código único do projeto
     * dentro da empresa.
     */
    ...
    /**
     * The column <code>public.projects.address_id</code>. FK opcional para
     * public.addresses(id), indicando o local físico principal do projeto.
     */
    ...
    /**
     * The column <code>public.projects.planned_start_date</code>. Data de
    ...
    /**
     * The column <code>public.projects.planned_end_date</code>. Data de término
    ...
    /**
     * The column <code>public.projects.actual_start_date</code>. Data de início
     * real do projeto.
     */
    ...
    /**
     * The column <code>public.projects.actual_end_date</code>. Data de término
     * real do projeto.
     */
    ...
    /**
     * The column <code>public.projects.client_name</code>. Nome do cliente para
     * o qual o projeto está sendo executado, se aplicável.
     */
    ...
    /**
     * The column <code>public.projects.project_status_id</code>. FK para
     * project_status(id), indicando o status atual do projeto.
     */
    val PROJECT_STATUS_ID: TableField<ProjectsRecord, Int?> = createField(DSL.name("project_status_id"), SQLDataType.INTEGER.nullable(false), this, "FK para project_status(id), indicando o status atual do projeto.")

    /**
     * The column <code>public.projects.budget</code>. Orçamento estimado ou
    ...
    /**
     * The column <code>public.projects.description</code>. Descrição detalhada
     * do escopo e objetivos do projeto.
     */
    ...
    /**
     * The column <code>public.projects.deleted_at</code>.
     */
    ...
    /**
     * The column <code>public.projects.version</code>.
     */
    ...
    /**
     * Get the implicit join path to the <code>public.project_status</code>
     * table.
     */
